...
import com.mist.refrigeratorreminder.data.local.IngredientSeedImporter
...
import com.mist.refrigeratorreminder.domain.search.IngredientSearchEngine
...
import com.mist.refrigeratorreminder.domain.model.PantryItemDraft
...
class PantryRepository(
    ...
    suspend fun searchIngredients(query: String): List<com.mist.refrigeratorreminder.domain.model.IngredientSuggestion> {
        ensureSeedData()
